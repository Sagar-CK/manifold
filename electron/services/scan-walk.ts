...
function pathHasDefaultExcludedSegmentStrict(
  filePath: string,
  segments?: readonly string[],
): boolean {
  const segs = segments ?? loadDefaultFolderExcludes();
...
export function isPathExcluded(
  ...
  useDefaultFolderExcludes: boolean,
  defaultFolderExcludeSegments?: readonly string[],
): boolean {
  ...
  return (
    ...
    pathHasDefaultExcludedSegmentStrict(filePath, defaultFolderExcludeSegments)
  );
}
...
export async function walkScanCandidates(
  ...
  const defaultFolderExcludeSegments = args.defaultFolderExcludeSegments;
