...
export const DESKTOP_API_UNAVAILABLE =
...
export function isDesktopAvailable(): boolean {
  return typeof window !== "undefined" && !!(window as Window & { desktop?: DesktopApi }).desktop;
}
...
export type GeminiApiKeySource = "appStorage" | "none";
...
export async function qdrantDockerQuickStartAvailable(): Promise<{
  ...
  return await invoke<{
    ...
    dockerInstalled: boolean;
    composeFile: string | null;
  }>("qdrant_docker_quick_start_available");
}
