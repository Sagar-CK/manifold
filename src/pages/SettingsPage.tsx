                      ...
                      tagsState.tags.map((t) => (
                        <TagDefBadge
                          ...
                          onRemove={() => {
                            ...
                            setTagsState(next);
                            saveTagsState(next);
                            const affected = Object.entries(
                              tagsState.pathToTagIds,
                            )
              ...
              >
                <DialogContent className="sm:max-w-md">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Name and color are shown on search cards and in the file
                      view.
                    </DialogDescription>
                  </DialogHeader>
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                            ...
                            onClick={async () => {
                              const dir =
                                await pickFolder("Add include folder");
                              if (!dir) return;
                              const nextIncludes = collapseIncludeFolders([
                                ...cfg.include,
                                dir,
                              ]);
                              if (nextIncludes.length === cfg.include.length)
                                return;
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                            ...
                            onClick={async () => {
                              const dir =
                                await pickFolder("Add exclude folder");
                              if (!dir) return;
                ...
                >
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Clears all indexed vectors for this profile. Files are
                        not deleted.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  indexed vectors for files in that folder. Your files on disk
                  are not deleted.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <ErrorMessage
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  dependencies, build outputs, and caches. Indexing will be
                  slower and API usage costs can increase significantly.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
